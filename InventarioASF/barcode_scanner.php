...
// Si hay una solicitud para guardar el lote
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'save_batch') {
    try {
        ...
        $result = $inventory->processBatch(
            $batchItems, 
            'Agregado por Producción - Lote ' . date('Y-m-d H:i:s')
        );
        
        $_SESSION['swal_success'] = true;
        $_SESSION['swal_message'] = "Lote procesado exitosamente: {$result['total_processed']} producto(s) actualizado(s)";
        if ($result['total_not_found'] > 0) {
            $_SESSION['swal_message'] .= ". {$result['total_not_found']} producto(s) no encontrado(s).";
        }
        echo "<script>window.location.href = 'altaProductos.php';</script>";
        exit;
...
<head>
    ...
    <title>Escáner de Códigos de Barras - Inventario</title>
    ...
    <style>
        ...
        @keyframes scanEffect {
            0% { background-color: rgba(0, 143, 57, 0.2); }
...
<body>
            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4 class="mb-0">Escáner de Códigos de Barras</h4>
                        <!--<a href="index.php" class="btn btn-light btn-sm">Volver al Inventario</a>-->
                    </div>
                    <div class="card-body">
                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody id="batch-items">
                                        ...
                                        <tr id="empty-batch-message">
                                            <td colspan="5" class="text-center">No hay productos escaneados en este lote</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                        ...
                                        <button id="save-batch-btn" class="btn btn-success" disabled>
                                            <i class="bi bi-check-circle"></i> Guardar en Inventario
                                        </button>
                                    </div>
                                </div>
                            </div>
    ...
    <!-- Agregar este script antes del cierre del head -->
    ...
    <!-- Incluir script adaptado para compatibilidad -->
    <script src="InventarioASF/barcode_scanner_js.js"></script>
</body>
</html>