    ...
    switch ($action) {
        case 'update':
            ...
            if ($id <= 0) {
                ...
                if ($campo == 'nombre') {
                    ...
                    $verificar_nombre = "SELECT id FROM vendedores WHERE nombre = '" . mysql_real_escape_string($valor) . "' AND id != $id LIMIT 1";
                ...
                $sql = "UPDATE vendedores SET " . $campo . " = '" . mysql_real_escape_string($valor) . "' WHERE id = $id";
        ...
        case 'add':
            ...
            if ($id <= 0) {
                ...
                $verificar_id = "SELECT id FROM vendedores WHERE id = $id LIMIT 1";
                ...
                if (mysql_num_rows($resultado_id) > 0) {
                    ...
                    $verificar_nombre = "SELECT id FROM vendedores WHERE nombre = '" . mysql_real_escape_string($nombre) . "' LIMIT 1";
                    $resultado_nombre = mysql_query($verificar_nombre);
                    ...
                    if (mysql_num_rows($resultado_nombre) > 0) {
                        ...
                        $sql = "INSERT INTO vendedores (id, nombre, telefono) 
