<?php
// /PedidosASF/almacen/tabla_vendedores.php
...
$sql = "SELECT id, nombre, telefono FROM vendedores ORDER BY $order_by $order_dir";
...
$ajax_processor_url = 'PedidosASF/almacen/procesar_vendedores.php';
