			    ...
			    <div class="panel panel-default">
			        <div class="panel-body">
			            ...
			            <div class="vendor-tabs-container">
			                ...
			                <!-- Primera fila de vendedores -->
			                <div class="vendor-tab" data-vendor="ABEL">ABEL</div>
			                <div class="vendor-tab" data-vendor="ADRIAN_BANDERAS">ADRIAN BANDERAS</div>
			                <div class="vendor-tab" data-vendor="ALEJANDRO_SOTO">ALEJANDRO SOTO</div>
			                <div class="vendor-tab" data-vendor="ANGEL_BOLANOS">ANGEL BOLAÑOS</div>
			                <div class="vendor-tab" data-vendor="CARLOS_MENDEZ">CARLOS MENDEZ</div>
			                <div class="vendor-tab" data-vendor="DANIEL_ORDONE">DANIEL ORDOÑE</div>
			                <div class="vendor-tab" data-vendor="EDGARDO_MOLINA">EDGARDO MOLINA</div>
			                <div class="vendor-tab" data-vendor="EDGARDO_RUEDA">EDGARDO RUEDA</div>
			                <div class="vendor-tab" data-vendor="ENRIQUE_SALAS">ENRIQUE SALAS</div>
			                
			                <!-- Segunda fila de vendedores -->
			                <div class="vendor-tab" data-vendor="ERNESTO_PESCADOR">ERNESTO PESCADOR</div>
			                <div class="vendor-tab" data-vendor="FERNANDO_VILLANUEVA">FERNANDO VILLANUEVA</div>
			                <div class="vendor-tab" data-vendor="FRANCISCO_MEDRANO">FRANCISCO MEDRANO</div>
			                <div class="vendor-tab" data-vendor="FROYLAN_TRUJILLO">FROYLAN TRUJILLO</div>
			                <div class="vendor-tab" data-vendor="ISAI_MORENO">ISAI MORENO</div>
			                <div class="vendor-tab" data-vendor="JUAN_CARLOS">JUAN CARLOS</div>
			                <div class="vendor-tab" data-vendor="JUAN_CARLOS_RICO">JUAN CARLOS RICO</div>
			                <div class="vendor-tab" data-vendor="KEVIN_SANTOYO">KEVIN SANTOYO</div>
			                <div class="vendor-tab" data-vendor="MARCO_SANCHEZ">MARCO SANCHEZ</div>
			                
			                <!-- Tercera fila de vendedores -->
			                <div class="vendor-tab" data-vendor="MARCOS_SANCHEZ">MARCOS SANCHEZ</div>
			                <div class="vendor-tab" data-vendor="MARIO_PEDROZA">MARIO PEDROZA</div>
			                <div class="vendor-tab" data-vendor="MARTIN_VACA">MARTIN VACA</div>
			                <div class="vendor-tab" data-vendor="NICOLAS_ENCINO">NICOLAS ENCINO</div>
			                <div class="vendor-tab" data-vendor="OFICINA">OFICINA</div>
			                <div class="vendor-tab" data-vendor="OMAR_RICO">OMAR RICO</div>
			                <div class="vendor-tab" data-vendor="OSCAR_BARRERA">OSCAR BARRERA</div>
			                <div class="vendor-tab" data-vendor="PABLO_ABAD">PABLO ABAD</div>
			                <div class="vendor-tab" data-vendor="SAUL_PRADO">SAUL PRADO</div>
			            </div>
			        </div>
			    </div>
			</div>                
...
document.addEventListener('DOMContentLoaded', function() {
	...
	function applyVendorFilter(vendorId) {
	    ...
	    vendorContainers.forEach(function(container) {
	        ...
	        // Verificar si el contenedor tiene un vendedor
	        if (vendorNameElement) {
	            ...
	            if (!vendorName || vendorName === '' || vendorName === '&nbsp;' || /^\s*$/.test(vendorName)) {
	                ...
	                // Para pedidos con vendedor, aplicar filtro normal
	                const normalizedVendorName = normalizeVendorName(vendorName);
	                
	                if (vendorId === 'todos' || normalizedVendorName === vendorId) {
    ...
    tabs.forEach(function(tab) {
        tab.addEventListener('click', function() {
            ...
            updateActionLinks(); // Actualizar los enlaces después de cambiar la pestaña
        });
    });
    ...
    // Mantener la funcionalidad existente del buscador
