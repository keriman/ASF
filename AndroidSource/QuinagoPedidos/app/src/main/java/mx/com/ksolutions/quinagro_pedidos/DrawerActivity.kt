...
import mx.com.ksolutions.quinagro_pedidos.databinding.ActivityDrawerBinding
...
class DrawerActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val vendorName = intent.getStringExtra("NOMBRE_VENDEDOR")
            ?: getSharedPreferences("QuinagroPrefs", MODE_PRIVATE).getString("NOMBRE_VENDEDOR", "")
            ?: ""
        val vendorUsername = intent.getStringExtra("USERNAME_VENDEDOR")
            ?: getSharedPreferences("QuinagroPrefs", MODE_PRIVATE).getString("USERNAME_VENDEDOR", "")
            ?: ""
