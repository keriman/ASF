            ...
            <div class="col-md-6 offset-md-3">
                <div class="card">
                    ...
                    <div class="card-footer text-center">
                        <a href="imprimir_simple.php?id=<?php echo $producto['id']; ?>" class="btn btn-success" target="_blank">Imprimir QR Simple</a>
                        <a href="../generador.php" class="btn btn-secondary">Volver a la lista</a>
                    </div>
                </div>
            </div>
        </div>
