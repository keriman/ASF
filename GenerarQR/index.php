...
$stmt = $pdo->query("SELECT id, name, description, barcode, stock FROM products ORDER BY id ASC");
...
<body>
    <div class="container mt-4">
        <div class="row mb-4">
            <div class="col">
                <h1 class="text-center">Generador de Códigos QR - Agro Santa Fé</h1>
            </div>
        </div>
        ...
        <div class="row mb-3">
            <div class="col">
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <a href="imprimir_todos_simple.php" class="btn btn-primary">Imprimir todos los QR (86 productos)</a>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        <a href="generar_qr_simple.php?id=<?php echo $producto['id']; ?>" class="btn btn-primary btn-sm" target="_blank">Ver QR Simple</a>
                                        <a href="imprimir_simple.php?id=<?php echo $producto['id']; ?>" class="btn btn-success btn-sm" target="_blank">Imprimir QR Simple</a>
                                    </div>
                                </td>
                            </tr>
                            <?php endforeach; ?>
